...
const createProduct = async function (req, res) {
    try {
        ...
        const { title, description, style, price, isFreeShipping, installments, currencyId, currencyFormat } = requestBody
...
const updatedProduct = async function (req, res) {
    try {
        ...
        const { title, description, style, price, currencyId, isFreeShipping, currencyFormat, installments } = requestBody
        let availableSizes = requestBody.availableSizes
        ...
        const updateProduct = await productModel.findOneAndUpdate({ _id: productId, isDeleted: false }, requestBody, { new: true })
        if (!updateProduct) {
